 ...
 */
final class Version20191203190634 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE nutrient (id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, unit_name VARCHAR(5) DEFAULT NULL, nutrient_nbr DOUBLE PRECISION DEFAULT NULL, rank INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
